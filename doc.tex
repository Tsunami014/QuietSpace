...
% Tests don't have to be code tests
...
The project was limited as procedural generation requires a lot of variety to look good, and while I have some it can get a bit boring over time. Easy future improvements would be better procedural generative algorithms and more tiles and decorations.
...
% Please include positives, negatives and how it affected the project (e.g. did it make some positive features less positive?) and things you wish were added

\begin{xltabular}{\textwidth}{|X|X|}
  \hline
  Positives & Negatives, Implications \& Future improvements \\
  \hline\hline
  \endhead
